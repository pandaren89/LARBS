...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/pandaren89/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/pandaren89/LARBS/master/progs.csv"
